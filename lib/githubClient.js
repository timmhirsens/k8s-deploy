...
exports.GH_CLIENT = exports.DEPLOYMENT_ENVIRONMENT = exports.GitHubClient = void 0;
    ...
    createDeployment() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            webRequest.body = JSON.stringify({
                ...
                environment: exports.DEPLOYMENT_ENVIRONMENT
            });
            const response = yield httpClient_1.sendRequest(webRequest);
...
exports.GH_CLIENT = new GitHubClient(process.env.GITHUB_REPOSITORY, input_parameters_1.githubToken);
