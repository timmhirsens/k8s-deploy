...
function deploy(kubectl, manifestFilePaths, deploymentStrategy) {
    return __awaiter(this, void 0, void 0, function* () {
        yield models.GH_CLIENT.createDeployment();
        yield models.GH_CLIENT.createDeploymentReference(models.DEPLOYMENT_ENVIRONMENT, models.DEPLOYMENT_ID, "in_progress");
        // get manifest files
        ...
        yield models.GH_CLIENT.createDeploymentReference(models.DEPLOYMENT_ENVIRONMENT, models.DEPLOYMENT_ID, "success");
    });
}
