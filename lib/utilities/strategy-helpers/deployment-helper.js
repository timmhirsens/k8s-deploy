...
function deploy(kubectl, manifestFilePaths, deploymentStrategy) {
    return __awaiter(this, void 0, void 0, function* () {
        yield githubClient_1.GH_CLIENT.createDeployment();
        yield githubClient_1.GH_CLIENT.createDeploymentStatus("in_progress");
        // get manifest files
        ...
        yield githubClient_1.GH_CLIENT.createDeploymentStatus("success");
    });
}
