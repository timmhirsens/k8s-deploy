...
exports.DEPLOYMENT_ENVIRONMENT = exports.GH_CLIENT = exports.DEPLOYMENT_ID = exports.getWorkflowAnnotationKeyLabel = exports.getWorkflowAnnotationsJson = exports.workloadTypesWithRolloutStatus = exports.workloadTypes = exports.deploymentTypes = exports.ServiceTypes = exports.DiscoveryAndLoadBalancerResource = exports.KubernetesWorkload = void 0;
...
exports.DEPLOYMENT_ID = Date.now().toString();
exports.GH_CLIENT = new githubClient_1.GitHubClient(process.env.GITHUB_REPOSITORY, input_parameters_1.githubToken);
exports.DEPLOYMENT_ENVIRONMENT = core.getInput("environment") || input_parameters_1.namespace;
